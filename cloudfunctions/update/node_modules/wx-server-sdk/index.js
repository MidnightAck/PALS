...
var error_config_1 = __webpack_require__(/*! ../../../api/cloud/provider/tcb/config/error.config */ "./src/api/cloud/provider/tcb/config/error.config.ts");
var error_config_2 = __webpack_require__(/*! ../../../config/error.config */ "./src/config/error.config.ts");
var limit_1 = __webpack_require__(/*! ./rules/limit */ "./src/api/openapi/namespace/rules/limit.ts");
...
function getGenericOpenAPI(cloud) {
    ...
    function callWXOpenAPI(options) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var displayAPIName, data, pairs, key, val, contentType, fileExtension, bufferSizeLimit, bufferSizeDisplayLimit, filename, valStr, pbMessage, callResult, result, wxResp, err, e_1;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        for (key in data) {
                            ...
                            if (type_1.isObject(val) && (val.contentType || val.content_type) && val.value && type_1.isBuffer(val.value)) {
                                ...
                                if (limit_1.config[options.api] && limit_1.config[options.api].bufferSize && limit_1.config[options.api].bufferSize[key]) {
                                    bufferSizeLimit = limit_1.config[options.api].bufferSize[key].limit;
                                    bufferSizeDisplayLimit = limit_1.config[options.api].bufferSize[key].displayLimit;
                                    if (val.value.byteLength > bufferSizeLimit) {
                                        throw new error_1.CloudSDKError({
                                            errCode: error_config_2.ERR_CODE.SDK_FUNCTIONS_EXCEED_REQ_DATA_SIZE_LIMIT,
                                            errMsg: key + ".value buffer size cannot exceed " + bufferSizeDisplayLimit,
                                        });
                                    }
                                }
...
/***/ "./src/api/openapi/namespace/rules/limit.ts":
/*!**************************************************!*\
  !*** ./src/api/openapi/namespace/rules/limit.ts ***!
  \**************************************************/
/*! no static exports found */
...
exports.ERR_CODE = {
    ...
    '-404010': 'request data size limit exceeded',
    SDK_FUNCTIONS_EXCEED_REQ_DATA_SIZE_LIMIT: -404010,
    // 微信服务器
    '-601001': 'system error',
